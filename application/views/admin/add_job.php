    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span><i class="icon-calendar"></i>নতুন জব যুক্ত করুন
            ...
            <div class="mws-panel-body no-padding">
                <form id="mws-validate" class="mws-form" action="<?php echo base_url(); ?>insert_data/save_jobs" method="post" enctype="multipart/form-data">
                    <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                    <div class="mws-form-inline">
                        <div class="mws-form-row">
                            <label for="newsTitle" class="mws-form-label">জব শিরনাম</label>
                            <div class="mws-form-item">
                                <input type="text" name="job_title" class="required large" id="newsTitle">
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label class="mws-form-label">জব বর্ণনা</label>
                            <div class="mws-form-item">
                                <textarea id="cleditor" name="job_description" class="large" required="required"></textarea>
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label for=newsImage class="mws-form-label">জব ছবি</label>
                            <div class="mws-form-item">
                                <input type="file" name="job_image" class="required" id="newsImage" />
